...
command=/bin/sh -c 'date; echo "Sleeping 25 seconds..."; sleep 25; date; echo "Running install"; sudo -u ${_CONTAINER_USER} bash -c "code-server --install-extension Continue.continue" && echo "✅ Extension installed successfully."'
autostart=true
autorestart=false
priority=20
