...
command=/bin/sh -c 'date; echo "Sleeping 40 seconds..."; sleep 40; date; echo "Running install"; code-server --install-extension Continue.continue; echo "✅ Extension installed successfully."'
user=$_CONTAINER_USER
autostart=true
autorestart=false
priority=20
